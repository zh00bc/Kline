...
struct ColorManager {
    ...
    let klineCnyRateColor = UIColor(hex: "#778899")
    let klineMinMaxValueColor = UIColor(hex: "#225566")

    let kColorShadeButtonGreenEnd = UIColor(hex: "#16B882")
    let kColorShadeButtonRedEnd = UIColor(hex: "#E03F67")
    ...
    let klineLatestPriceLabelBorderColor = UIColor.clear //UIColor(red: 0.427451, green: 0.529412, blue: 0.658824, alpha: 1)
    ...
    let klineMA3Color = UIColor(hex: "#BB64D1")
